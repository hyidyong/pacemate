...
grant select, insert, update, delete on public.professor_admin_tasks to anon, authenticated;

create policy "demo anon manage professor admin tasks" on public.professor_admin_tasks for all to anon using (professor_id is not null) with check (professor_id is not null);
create policy "demo auth manage professor admin tasks" on public.professor_admin_tasks for all to authenticated using (true) with check (true);
